...
function Modules() {
    return(
        <section className={styles.home_container}>
            ...
            <Module contents={['Condições if, elif e else e operadores de comparação', 'Operadores lógicos', 'Laço de repetição for e iterações', 'Laço de repetição while', 'Early exit com break e continue']} num_module='2' link='modulo-2'/>
